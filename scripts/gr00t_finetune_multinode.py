...
class ArgsConfig:
    ...
    run_name: str = "0804_bridge_noAugSteps_noDeltePauseFrame"
    """Name of the run."""

    output_dir: str = "/mnt/petrelfs/wangfangjing/code/Isaac-GR00T-M1/playground/Checkpoints/0804_bridge_noAugSteps_noDeltePauseFrame"
    """Directory to save model checkpoints."""

    data_config: Literal[tuple(DATA_CONFIG_MAP.keys())] = "oxe_bridge"
...
def already_distributed() -> bool:
    ...
    print(f"WORLD_SIZE: {os.getenv('WORLD_SIZE', '1')}")
    print(f"LOCAL_RANK: {os.getenv('LOCAL_RANK', '1')}")
    print(f"RANK: {os.getenv('RANK', '1')}")
    print(f"TORCHELASTIC_RUN_ID: {os.getenv('TORCHELASTIC_RUN_ID', 'None')}")
