...
DATA_CONFIG_MAP = {
    ...
    "single_panda_hand": SinglePandaHandDataConfig(),
    "single_franka_robotiq_delta_eef": SingleFrankaRobotiqDeltaEefDataConfig(),
    "single_franka_robotiq_delta_joints": SingleFrankaRobotiqDeltaJointsDataConfig(),
